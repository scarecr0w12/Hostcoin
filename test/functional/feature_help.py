...
"""Verify that starting hostcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hostcoin with -h for help text")
        ...
        self.log.info("Start hostcoin with -version for version information")
        ...
        self.log.info("Start hostcoind with -fakearg to make sure it does not start")
