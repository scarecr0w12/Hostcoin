...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.hostcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.hostcointools.com");
        vSeeds.emplace_back("dnsseed.hostcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.hostcointools.com");
        vSeeds.emplace_back("seed-b.hostcoin.loshan.co.uk");
