...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " hostcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  hostcoin-tx [options] <hex-tx> [commands]  Update hex-encoded hostcoin transaction\n" +
            "or:     hostcoin-tx [options] -create [commands]   Create hex-encoded hostcoin transaction\n" +
            "\n";
