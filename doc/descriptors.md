# Support for Output Descriptors in hostcoin Core

Since hostcoin Core v0.17, there is support for Output Descriptors. This is a
...
on hostcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing hostcoin Core wallets, a convenience function `combo` is
