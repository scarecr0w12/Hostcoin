hostcoin Core version *0.15.1* is now available from:

  <https://download.hostcoin.org/hostcoin-0.15.1/>
...
A number of changes to the way hostcoin Core deals with peer connections and invalid blocks
